...
module k03_command_boundary_test_top #(
    ...
    pcie_phy_command_ctrl u_phy_command_ctrl (
        ...
        .phy_txeq_new_coeff(18'd0), .phy_txeq_done(1'b0),
    ...
    pcie_ltssm_mac_gen1 #(
        ...
        .eq_req_ready(1'b1), .eq_busy(1'b0), .eq_done(1'b0),
        .eq_result(3'd0), .eq_rsp_preset_sel(1'b0),
        .eq_rsp_coeff(18'd0), .gen3_eq_active(), .gen3_eq_phase(),
        .gen3_eq_failed(),
