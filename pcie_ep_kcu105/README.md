...
- K12：**K12-A CDC mailbox PASS；K12-B Recovery.Speed骨架 PASS**；已完成Retrain
  原子跨域、正常切速、PHY done超时、对端拒绝、非法目标和Gen1回退的独立验证；
  下一步接入行为PHY/真实Ordered Set和EQ，生产LTSSM仍保持K11 release基线。
