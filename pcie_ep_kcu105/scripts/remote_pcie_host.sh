...
retrain_gen3() {
    ...
    # +0x2c.  Keep the endpoint at Gen1 before requesting explicit retrain.
    ssh_run "set -e; \
        sudo -n setpci -s '$remote_rp_bdf' CAP_EXP+2c.w=0001:000f; \
        ...
        sudo -n setpci -s '$remote_rp_bdf' CAP_EXP+2c.w=0003:000f; \
        sudo -n setpci -s '$remote_rp_bdf' CAP_EXP+0c.w=0020:0020; \
