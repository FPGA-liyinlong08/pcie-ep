...
module kcu105_pcie_gen1_top #(
    ...
    pcie_ltssm_mac_gen1 #(
        ...
        .eq_req_valid(), .eq_req_kind(), .eq_req_preset(), .eq_req_coeff(),
        .eq_req_ready(1'b0), .eq_busy(1'b0), .eq_done(1'b0),
        .eq_result(3'd0), .eq_rsp_preset_sel(1'b0), .eq_rsp_coeff(18'd0),
        .prerate_query_valid(1'b0), .prerate_query_coeff(18'd0),
        .local_txeq_fs(phy_txeq_fs), .local_txeq_lf(phy_txeq_lf),
        .prerate_preset_valid(), .prerate_preset(),
        .gen3_eq_active(), .gen3_eq_phase(), .gen3_eq_failed(),
        .phy_txdata             (phy_txdata),
        .phy_txdatak            (phy_txdatak),
        .phy_txdata_valid       (phy_txdata_valid),
        .phy_txstart_block      (phy_txstart_block),
