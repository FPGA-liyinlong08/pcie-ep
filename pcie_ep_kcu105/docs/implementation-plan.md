...
状态：**计划 v1 已冻结；K00～K11-A PASS；K11-B1冻结，K11-B2 Directed/Vivado PASS、VCS修改后重跑待许可证；实板延期**
...
| K11-B | Gen1真PHY/实板全集成 | B1已冻结；B2真实PHY InitFC/枚举/BAR基础路径及KU040实现PASS，修改后VCS重跑、串行随机/注错待完成；KCU105实板延期 |
