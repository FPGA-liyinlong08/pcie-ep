...
| K13 | Gen3 全集成 | 在建基线见架构、接口和验证计划；标准Retrain已接入生产`Recovery.Speed`握手，超时/Rate ID/ILA可观测性已修正，K03/K12/K13/lint通过。仍需真实Gen3 TS/EQ字段和128b/130b路径、GT CDR-loss、VCS elaboration、Vivado时序/bit、KCU105 Gen3 x1枚举和10万次BAR随机操作 |
