...
状态：**计划 v1 已冻结；K00～K11 PASS；K11-PHASE-RELEASE-v1 已冻结；K12已完成；K13控制阶段启动**
...
| K13 | Gen3 全集成 | 当前完成K13控制阶段：生产Recovery/Speed/EQ组合控制器及Gen3/回退/非法TS门禁PASS；下一门为生产顶层LTSSM/PHY接线、VCS Gen1→Gen3、KCU105 Gen3 x1枚举和10万次BAR随机操作 |
