# Build the 14aba94-based pcie_phy_0_ex KCU105 Hardware Golden image.
# The original imports/phy_ctrl.v remains in the PHY command path.  The only
# new control logic is phy_bringup_seq, which reproduces imports/board.v's
# Gen1 -> Gen3 six-input stimulus.

set script_dir  [file dirname [file normalize [info script]]]
set project_dir [file normalize [file join $script_dir ..]]
set imports_dir [file join $project_dir imports]
set build_dir   [file join $script_dir build_hardware_golden]
...
create_debug_core u_ila_phy_golden ila
set_property C_DATA_DEPTH 8192 [get_debug_cores u_ila_phy_golden]
set_property C_TRIGIN_EN false [get_debug_cores u_ila_phy_golden]
set_property C_TRIGOUT_EN false [get_debug_cores u_ila_phy_golden]
set_property C_INPUT_PIPE_STAGES 1 [get_debug_cores u_ila_phy_golden]
connect_debug_port u_ila_phy_golden/clk [one_net {(^|/)phy_pclk$}]
...
add_probe u_ila_phy_golden 0 $probe0
...
add_probe u_ila_phy_golden 1 $probe1
...
set bit_path [file join $build_dir pcie_phy_0_ex_hardware_golden_ila.bit]
set ltx_path [file join $build_dir pcie_phy_0_ex_hardware_golden_ila.ltx]
write_debug_probes -force $ltx_path
write_bitstream -force $bit_path

set summary [open [file join $build_dir impl_summary.txt] w]
puts $summary "PCIE_PHY_0_EX_HARDWARE_GOLDEN_IMPL_PASS"
puts $summary "baseline=14aba94"
...
close $summary
puts "PCIE_PHY_0_EX_HARDWARE_GOLDEN_IMPL_PASS bitstream=$bit_path probes=$ltx_path"
